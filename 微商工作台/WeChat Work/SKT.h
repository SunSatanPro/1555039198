...
#define SKAccount(x) [((NSString *)x) stringByAppendingString:([[[NSUserDefaults standardUserDefaults] objectForKey:@"WeChatWorkLogin"] objectForKey:@"WeChatWorkAccount"])?([[[NSUserDefaults standardUserDefaults] objectForKey:@"WeChatWorkLogin"] objectForKey:@"WeChatWorkAccount"]):@"WeChatWork"]
#define SKAccountName ([[[NSUserDefaults standardUserDefaults] objectForKey:@"WeChatWorkLogin"] objectForKey:@"WeChatWorkAccount"])?([[[[NSUserDefaults standardUserDefaults] objectForKey:@"WeChatWorkLogin"] objectForKey:@"WeChatWorkAccount"] isEqualToString:@"WeChatWork"]?@"微商工作台":[[[NSUserDefaults standardUserDefaults] objectForKey:@"WeChatWorkLogin"] objectForKey:@"WeChatWorkAccount"]):@"微商工作台"

#define SKLogin  [[NSUserDefaults standardUserDefaults] objectForKey:@"WeChatWorkLogin"]
...
#define SKThemeColor  [UIColor colorWithHex:@"4EBD61"]
#define SKTextColor   [UIColor colorWithHex:@"72209d"]
#define SKBadgeColor   [UIColor colorWithHex:@"C74627"]
#define SKCurrentColor ((UIColor *)([UIColor colorWithHex:SKUserGet(@"SKCurrentColor")?SKUserGet(@"SKCurrentColor"):@"4EBD61"]))
