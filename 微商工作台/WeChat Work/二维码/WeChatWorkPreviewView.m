...
#import "WeChatWorkPreviewView.h"

@interface WeChatWorkPreviewView ()
...
@implementation WeChatWorkPreviewView

- (instancetype)initWithFrame:(CGRect)frame {
    
    return [[WeChatWorkPreviewView alloc] initWithFrame:frame rectFrame:CGRectZero rectColor:[UIColor clearColor]];
}

- (instancetype)initWithFrame:(CGRect)frame rectColor:(UIColor *)rectColor {
    
    return [[WeChatWorkPreviewView alloc] initWithFrame:frame rectFrame:CGRectZero rectColor:rectColor];
}

- (instancetype)initWithFrame:(CGRect)frame rectFrame:(CGRect)rectFrame {
    
    return [[WeChatWorkPreviewView alloc] initWithFrame:frame rectFrame:rectFrame rectColor:[UIColor clearColor]];
}
